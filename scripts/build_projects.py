    ...
    <div class="container header__in">
      ...
      <nav class="nav" id="nav" aria-label="Основная навигация">
        ...
        <div class="nav__contacts">
          ...
          <button class="btn nav__cta" type="button" data-modal-open>Оставить заявку</button>
        </div>
      </nav>
      <div class="header__contacts">
        ...
        <button class="btn btn--sm" type="button" data-modal-open>Оставить заявку</button>
      </div>
