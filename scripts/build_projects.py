    ...
    <div class="container header__in">
      ...
      <nav class="nav" id="nav" aria-label="Основная навигация">
        ...
        <div class="nav__contacts">
          ...
          <button class="messenger-btn" type="button" data-modal-open aria-label="Оставить заявку — форма обратной связи" title="Оставить заявку"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 5h18a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm1 2.2V17h16V7.2l-8 5.1-8-5.1ZM19.6 7H4.4l7.6 4.8L19.6 7Z"/></svg></button>
        </div>
        </div>
      </nav>
...
{paragraphs}
  ...
  <div class="modal" id="callback-modal" aria-hidden="true">
    ...
    <div class="modal__box" role="dialog" aria-modal="true" aria-labelledby="callback-title">
